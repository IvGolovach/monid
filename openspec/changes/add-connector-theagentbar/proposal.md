...
- Add four fixed-price partner purchase endpoints (USD 0.50, 2.50, 10.00, 25.00)
  using native PER_CALL usage, a restricted provider credential, and host-stable
...
credentials, verified host run/billing deduplication, and agreed settlement/refund
terms. Vendor usage, Monid wallet debits, and vendor payouts remain separate.
